package spring.springtf.testdata;
...
import spring.springtf.domain.repository.FolderRepository;
import spring.springtf.domain.repository.ProductRepository;
import spring.springtf.domain.repository.UserRepository;
import spring.springtf.enumerate.UserRoleEnum;
import spring.springtf.service.ItemSearchService;
import spring.springtf.service.UserService;

import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

import static spring.springtf.service.ProductService.MIN_MY_PRICE;
